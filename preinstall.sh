echo 'Server = https://mirrors.cnnic.cn/archlinux/$repo/os/$arch' > /etc/mirrir.d/mirrorlist
echo 'Server = http://mirrors.163.com/archlinux/$repo/os/$arch' >> /etc/mirrir.d/mirrorlist
echo 'Server = http://mirrors.aliyun.com/archlinux/$repo/os/$arch' >> /etc/mirrir.d/mirrorlist
pacman -Sy
