...
sed -i "1iServer = https://mirrors.cnnic.cn/archlinux/$repo/os/$arch" /etc/pacman.d/mirrorlist
sed -i "2iServer = http://mirrors.163.com/archlinux/$repo/os/$arch" /etc/pacman.d/mirrorlist
sed -i "3iServer = http://mirrors.aliyun.com/archlinux/$repo/os/$arch" /etc/pacman.d/mirrorlist
